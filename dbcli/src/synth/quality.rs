...
/// Generated-file reader lifted to [`crate::tabular`] so the `load`
/// command (not feature-gated) can share it.
pub(crate) use crate::tabular::read_generated_table;
...
/// Generated-file table types lifted to [`crate::tabular`] so the `load`
/// command (not feature-gated) can share them.
pub(crate) use crate::tabular::{GeneratedColumns, GeneratedTables};
